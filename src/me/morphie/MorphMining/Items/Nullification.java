...
public class Nullification {
	...
	public Nullification(Main plugin) {
		this.plugin = plugin;
	}
	...
	public void openGUINullifier(Player player) {
		...
		if (new playerFileMethods(this.plugin).getBoolean(uuid, "Trashcan.Nullifier.Enabled") == false) {
			Enabled.add(ChatColor.translateAlternateColorCodes('&', this.plugin.getMessage("Menus.LoreColor") + "Click to enable your trashcan."));
			Nullifier.setItem(4, this.plugin.createInventoryItem("RED_STAINED_GLASS_PANE", 1, "&cFalse" + this.plugin.getMessage("Menus.SpacerColor") + ":", Enabled, false, 10000));
		} else {
			Enabled.add(ChatColor.translateAlternateColorCodes('&', this.plugin.getMessage("Menus.LoreColor") + "Click to enable your trashcan."));
		...
		if (new playerFileMethods(this.plugin).getMaterial(uuid, "Trashcan.Nullifier.Slot1.Material") == null && new playerFileMethods(this.plugin).getBoolean(uuid, "Trashcan.Nullifier.Slot1.Enabled") == false) {
			...
			Nullifier.setItem(1, this.plugin.createInventoryItem(item.getType().name(), 1, this.plugin.getMessage("Menus.ItemColor") + item.getType().name().toString() + this.plugin.getMessage("Menus.SpacerColor") + ":", Slot1, false, 10000));
		}
		...
		if (new playerFileMethods(this.plugin).getBoolean(uuid, "Trashcan.Nullifier.Slot2.Purchased") == false) {
			...
			Slot2.add(ChatColor.translateAlternateColorCodes('&', this.plugin.getMessage("Menus.LoreColor") + "Slot currently empty. Click then"));
			Slot2.add(ChatColor.translateAlternateColorCodes('&', this.plugin.getMessage("Menus.LoreColor") + "add an item in the empty slot below!"));
			...
			Nullifier.setItem(2, this.plugin.createInventoryItem(item.getType().name(), 1, this.plugin.getMessage("Menus.ItemColor") + item.getType().name().toString() + this.plugin.getMessage("Menus.SpacerColor") + ":", Slot2, false, 10000));
		}
		...
		if (new playerFileMethods(this.plugin).getBoolean(uuid, "Trashcan.Nullifier.Slot3.Purchased") == false) {
			...
			Slot3.add(ChatColor.translateAlternateColorCodes('&', this.plugin.getMessage("Menus.LoreColor") + "Slot currently empty. Click then"));
			Slot3.add(ChatColor.translateAlternateColorCodes('&', this.plugin.getMessage("Menus.LoreColor") + "add an item in the empty slot below!"));
			...
			Nullifier.setItem(6, this.plugin.createInventoryItem(item.getType().name(), 1, this.plugin.getMessage("Menus.ItemColor") + item.getType().name().toString() + this.plugin.getMessage("Menus.SpacerColor") + ":", Slot3, false, 10000));
		}
		...
		if (new playerFileMethods(this.plugin).getBoolean(uuid, "Trashcan.Nullifier.Slot4.Purchased") == false) {
			...
			Slot4.add(ChatColor.translateAlternateColorCodes('&', this.plugin.getMessage("Menus.LoreColor") + "Slot currently empty. Click then"));
			Slot4.add(ChatColor.translateAlternateColorCodes('&', this.plugin.getMessage("Menus.LoreColor") + "add an item in the empty slot below!"));
			...
			Nullifier.setItem(7, this.plugin.createInventoryItem(item.getType().name(), 1, this.plugin.getMessage("Menus.ItemColor") + item.getType().name().toString() + this.plugin.getMessage("Menus.SpacerColor") + ":", Slot4, false, 10000));
		}
		...
		if (new playerFileMethods(this.plugin).getBoolean(uuid, "Trashcan.LavaRepair.Enabled") == false) {
			...
			Nullifier.setItem(27, this.plugin.createInventoryItem("FLINT_AND_STEEL", 1, this.plugin.getMessage("Menus.ItemColor") + "Lava Tank" + this.plugin.getMessage("Menus.SpacerColor") + ":", LavaRepair, false, new playerFileMethods(this.plugin).getStat(uuid, "Trashcan.LavaRepair.Durability")));
		} else {
			...
			Nullifier.setItem(27, this.plugin.createInventoryItem("FLINT_AND_STEEL", 1, this.plugin.getMessage("Menus.ItemColor") + "Lava Tank" + this.plugin.getMessage("Menus.SpacerColor") + ":", LavaRepair, true, new playerFileMethods(this.plugin).getStat(uuid, "Trashcan.LavaRepair.Durability")));
		}
		...
		if (new playerFileMethods(this.plugin).getBoolean(uuid, "Trashcan.IronRepair.Enabled") == false) {
			...
			Nullifier.setItem(35, this.plugin.createInventoryItem("ANVIL", 1, this.plugin.getMessage("Menus.ItemColor") + "Structure Integrity" + this.plugin.getMessage("Menus.SpacerColor") + ":", IronRepair, false, new playerFileMethods(this.plugin).getStat(uuid, "Trashcan.IronRepair.Durability")));
		} else {
			...
			Nullifier.setItem(35, this.plugin.createInventoryItem("ANVIL", 1, this.plugin.getMessage("Menus.ItemColor") + "Structure Integrity" + this.plugin.getMessage("Menus.SpacerColor") + ":", IronRepair, true, new playerFileMethods(this.plugin).getStat(uuid, "Trashcan.IronRepair.Durability")));
		}
		
		ArrayList<String> glass = new ArrayList();
		glass.add(" ");
		Nullifier.setItem(0, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(3, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(5, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(8, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(9, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(10, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(11, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(12, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(13, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(14, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(15, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(16, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(17, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(20, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(24, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(29, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(33, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(38, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(42, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(45, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(46, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(48, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(49, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(50, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(52, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(53, this.plugin.createInventoryItem("BLACK_STAINED_GLASS_PANE", 1, " ", glass, false, 10000));
		Nullifier.setItem(18, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(19, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(21, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(22, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(23, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(25, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(26, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(28, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(30, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(32, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(34, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(36, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(37, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(39, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(40, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(41, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(43, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
		Nullifier.setItem(44, this.plugin.createInventoryGlassItem("LEGACY_STAINED_GLASS_PANE", this.plugin.getConfig().getInt("Settings.MainGlassColor"), 1, " ", glass, false));
